"""
Django settings for attdemoapp_44982 project.
...
ROOT_URLCONF = 'attdemoapp_44982.urls'
...
WSGI_APPLICATION = 'attdemoapp_44982.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "attdemoapp_44982 API",
    "DESCRIPTION": "API documentation for attdemoapp_44982 App",
    "VERSION": "v1",
}
